...
@Scripts({
       @Script(id = "jquery", value = "js/jquery/jquery-1.12.3.js"),
        @Script(id = "datatables", value = "js/datatable/jquery.dataTables.min.js",depends = "jquery"),
        @Script(id = "datatables-buttons", value = "js/datatable/dataTables.buttons.min.js",depends={"jquery","datatables"}),
        @Script(id = "hibernate-statistics-js", value = "js/hibernatestatistics/hibernatestatistics.js",depends ={"datatables-buttons"})
})
